...
public class AssociationController {
    ...
    @RequestMapping(value = "packet_info", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public String getPackageInfo(@RequestParam("topic_id") String topicId){
        return didVoteService.peekPacketData(topicId);
    }
